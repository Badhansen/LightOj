...
int main ()
{
    ...
    while(cnt <= test){
        ...
        i64 num, row, col, res, l, h, mid;
        scanf("%lld", &num);
        res=1LL*sqrt(num);
        if(res*res == num){
            // if the number is perfect square
            if(num & 1){
                // if the number is odd the it is situated in the column 1 and sqrt(num) row
                ...
                // if the number is even the it is situated in the row 1 and sqrt(num) column
            ...
            if(res & 1){
                ...
                if(num > mid){
                    // if the number is greater than mid then we will decrease the column
                    col -= (num - mid);
                }
                else{
                    // if the number is less than mid then we will decrease the row
                    row -= (mid - num);
                }
                ...
                if(num > mid){
                    // if the number is greater than mid then we will decrease the row
                    row -= (num - mid);
                }
                else{
                    // if the number is less than mid then we will decrease the column
                    col -= (mid - num);
                }
